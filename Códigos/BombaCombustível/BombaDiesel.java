...
public class BombaDiesel {
  // Atributos
  private double valorLitro;
  private double quantidadeCombustivel;

  // Construtor
  public BombaDiesel(double valorLitro, double quantidadeCombustivel) {
  ...
  public void abastecerPorValor() {
    ...
    if (litros > quantidadeCombustivel) {
      System.out.println("Não há Diesel suficiente na bomba para este valor.");
