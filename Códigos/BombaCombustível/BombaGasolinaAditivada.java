...
public class BombaGasolinaAditivada {
  // Atributos
  private double valorLitro;
  private double quantidadeCombustivel;

  // Construtor
  public BombaGasolinaAditivada(double valorLitro, double quantidadeCombustivel) {
  ...
  public void abastecerPorValor() {
    ...
    if (litros > quantidadeCombustivel) {
      System.out.println("Não há gasolina suficiente na bomba para este valor.");
